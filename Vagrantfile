...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "pungoyal-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/puneet"
  #   chef.validation_client_name = "puneet-validator"
  #   chef.validation_key_path = ".chef/puneet-validator.pem"
  # end
end
